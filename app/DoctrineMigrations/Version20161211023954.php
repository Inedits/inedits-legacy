 ...
 */
class Version20161211023954 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE post (id INT UNSIGNED AUTO_INCREMENT NOT NULL, root_id INT UNSIGNED DEFAULT NULL, user_id INT UNSIGNED NOT NULL, parent_id INT UNSIGNED DEFAULT NULL, title VARCHAR(255) NOT NULL, content LONGTEXT DEFAULT NULL, content_plain LONGTEXT DEFAULT NULL, file VARCHAR(255) DEFAULT NULL, is_main TINYINT(1) DEFAULT \'0\' NOT NULL, is_end TINYINT(1) DEFAULT \'0\' NOT NULL, lft INT NOT NULL, rgt INT NOT NULL, lvl INT NOT NULL, slug VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, UNIQUE INDEX UNIQ_5A8A6C8D989D9B62 (slug), INDEX IDX_5A8A6C8D79066886 (root_id), INDEX IDX_5A8A6C8DA76ED395 (user_id), INDEX IDX_5A8A6C8D727ACA70 (parent_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
